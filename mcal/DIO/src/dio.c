...
{
	/*	show me your code */
	dio_level_t pin_state =STD_LOW;
	switch(port)
	{
		case DIO_PORTA:
		pin_state = CHECK_BIT(DIO_PINA_REG,channel) ;
		break;
		case DIO_PORTB:
		pin_state = CHECK_BIT(DIO_PINB_REG,channel) ;
		break;
		case DIO_PORTC:
		pin_state = CHECK_BIT(DIO_PINC_REG,channel) ;
		break;
		case DIO_PORTD:
		pin_state = CHECK_BIT(DIO_PIND_REG,channel) ;
		break;
	}
	return pin_state;
}
